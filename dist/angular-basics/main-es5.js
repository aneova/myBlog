...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppOrganizerOrganizerComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div class=\"container\">\n    <header class=\"header\">\n        <app-selector></app-selector>\n    </header>\n    <main>\n        <app-calendar></app-calendar>\n    </main>\n\n    <section>\n    <div class=\"header\">Organizer:<strong>\n               {{ dateService.date|async|moment: 'DD.MM.YYYY' }}\n           </strong>\n    </div>\n\n    <form (ngSubmit)=\"submit()\" [formGroup] = \"form\">\n        <input type=\"text\" placeholder=\"Enter task here\" formControlName=\"title\">\n        <button type=\"submit\" class=\"btn btn-block\"\n            [disabled]=\"form.invalid\">Add</button>\n    </form>\n\n    <div>\n        <ul>\n            <li class=\"task\">\n                   <span>1 task</span>\n\n                        <button type=\"submit\" class=\"btn btn-block btn-danger\">Remove</button>\n            </li>\n        </ul>\n    </div>\n    </section>\n</div>\n\n";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSelectorSelectorComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _organizer_organizer_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./organizer/organizer.component */
    ...
    var routes = [{
      ...
      path: 'organizer',
      component: _organizer_organizer_component__WEBPACK_IMPORTED_MODULE_12__["OrganizerComponent"]
    }, {
      path: 'posts',
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(resolver, title, meta) {
        ...
        meta.addTags([{
          name: 'keywords',
          content: 'Fisrt Angular examples'
        }, {
          name: 'description',
          content: 'Description of the Angular Blog'
        }]);
      } // showWindow() {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _organizer_organizer_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! ./organizer/organizer.component */
    "./src/app/organizer/organizer.component.ts");
    /* harmony import */


    var _calendar_calendar_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    /*! ./calendar/calendar.component */
    "./src/app/calendar/calendar.component.ts");
    /* harmony import */


    var _selector_selector_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
    /*! ./selector/selector.component */
    "./src/app/selector/selector.component.ts");
    /* harmony import */


    var _shared_moment_pipe__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    /*! ./shared/moment.pipe */
  ...
  function srcAppCalendarCalendarComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "table {\n  width: 100%;\n  margin-bottom: 1rem;\n  border-collapse: collapse;\n}\ntable td, table th {\n  border: 1px solid black;\n  padding: 0.5rem 1rem;\n}\ntable td {\n  text-align: center;\n  -webkit-transition: all 0.3s;\n  transition: all 0.3s;\n}\ntable td.disabled {\n  opacity: 0.5;\n  color: gray;\n}\ntable td:hover:not(.disabled) {\n  background: #65d607;\n  cursor: pointer;\n}\ntable .active {\n  color: var(--primary-color);\n  font-weight: bold;\n}\ntable .selected {\n  color: #125699;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppCalendarCalendarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_date_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../shared/date.service */
          ...
          while (date.isBefore(endDay, 'day')) {
            calendar.push({
              days: Array(7).fill(0).map(function () {
                ...
                var disabled = !now.isSame(value, 'month'); // If it does not coincidence with current month
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function HomeComponent(router) {
        ...
        this.router = router;
        this.isOpen = true;
        this.isCursor = true; // tslint:disable-next-line:max-line-length

        this.ctext = 'Hello! My name is Anna! This website is devoted to study of the Angular8 framework. The source code can be found here http://github.com/aneova.' + ' If you have any suggestions about my codes and performance, do not hesitate to contact me Anna.Neova@gmail.com';
        this.chCtext = '';
        this.i = 0;
      }
  ...
  /***/
  function srcAppOrganizerOrganizerComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ":root {\n  --primary-color: #ff192e;\n  --dark-color: #333333;\n  --light-color: #f4f4f4;\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\nbody {\n  font-family: Apple, \"sans-serif\";\n  font-size: 1rem;\n  line-height: 1.6;\n  background: white;\n  color: #125699;\n}\n\na {\n  color: var(--primary-color);\n  text-decoration: none;\n}\n\na:hover {\n  color: powderblue;\n}\n\nul {\n  list-style: none;\n}\n\ninput {\n  display: block;\n  width: 100%;\n  padding: 0.4rem;\n  font-size: 1.2rem;\n  border: 1px solid #ccc;\n  outline: none;\n  margin-bottom: 0.5rem;\n}\n\n.container {\n  max-width: 1100px;\n  margin: auto;\n  overflow: hidden;\n  padding: 0.2rem;\n}\n\ntable th {\n  background: var(--light-color);\n}\n\n.btn-block {\n  display: block;\n  width: 100%;\n}\n\n.btn-center {\n  background: var(--primary-color);\n  color: white;\n}\n\n.text-center {\n  text-align: center;\n}\n\n.header {\n  padding: 1rem 1rem;\n  margin-bottom: 1rem;\n}\n\n.section {\n  border: 1px solid #000;\n  padding: 1rem;\n}\n\n.section header {\n  margin-bottom: 1rem;\n}\n\n.task {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-pack: justify;\n          justify-content: space-between;\n  -webkit-box-align: center;\n          align-items: center;\n  padding: 0.5rem 1rem;\n  border: 1px solid #ccc;\n  margin-bottom: 0.5rem;\n}\n\n.footer {\n  display: block;\n  padding: 1rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppOrganizerOrganizerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OrganizerComponent", function () {
    ...
    var _shared_date_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../shared/date.service */
    "./src/app/shared/date.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function OrganizerComponent(dateService) {
        _classCallCheck(this, OrganizerComponent);

        this.dateService = dateService;
      }

      _createClass(OrganizerComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
    ...
    OrganizerComponent.ctorParameters = function () {
      return [{
        type: _shared_date_service__WEBPACK_IMPORTED_MODULE_2__["DateService"]
      }];
    };

    OrganizerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-organizer',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./organizer.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/organizer/organizer.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./organizer.component.scss */
      "./src/app/organizer/organizer.component.scss")).default]
    })], OrganizerComponent);
    /***/
  },
  ...
  function srcAppPlayerPlayerComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".audio-progress-bar {\n  /* remove animation and the dots*/\n}\n.audio-progress-bar.mat-progress-bar {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n          flex-direction: row;\n  width: 300px;\n  height: 10px;\n}\n.audio-progress-bar .mat-progress-bar-fill::after {\n  background-color: #37474f;\n}\n.audio-progress-bar .mat-progress-bar-buffer {\n  background-color: #90a4ae;\n}\n.audio-progress-bar .mat-progress-bar-background {\n  -webkit-animation: none;\n          animation: none;\n  background-color: #800000;\n  fill: #eceff1;\n}\n.media-action-bar {\n  width: 100%;\n  padding: 2.5rem;\n  -webkit-box-pack: center;\n          justify-content: center;\n}\n.mat-icon {\n  height: 48px !important;\n  width: 48px !important;\n  font-size: 48px !important;\n}\n.terminal pre {\n  font-family: SFMono-Regular, Consolas, Liberation Mono, Menlo, monospace;\n  color: white;\n  padding: 0 1rem 1rem;\n  margin: 0;\n}\n.musicList {\n  position: relative;\n  max-width: 500px;\n  border-radius: 2rem;\n  background-color: #FFFFFF;\n  padding: 1rem;\n  left: 25%;\n}\nh2 {\n  padding: 5% 0 0 27%;\n}\np {\n  cursor: pointer;\n}\np:hover {\n  background: powderblue;\n}\n.player {\n  position: relative;\n  left: 25%;\n  max-width: 600px;\n}\n.text {\n  max-width: 600px;\n  background-color: #2b4e8b;\n  color: #FFFFFF;\n  text-align: center;\n  font-size: 2rem;\n  border-radius: 3rem;\n}\n.skin-no-animation {\n  position: relative;\n  border-radius: 100%;\n  background-repeat: no-repeat;\n  width: 300px;\n  height: 300px;\n  left: 25%;\n  border: 3px double rgba(28, 110, 164, 0.83);\n  background-image: url('sky.jpeg');\n  background-position: 50% 50%, 100%, 20px 20px, 50%, 0 90%;\n}\n.skin {\n  position: relative;\n  border-radius: 100%;\n  background-repeat: no-repeat;\n  width: 300px;\n  height: 300px;\n  left: 25%;\n  border: 3px double rgba(28, 110, 164, 0.83);\n  background-image: url('sky.jpeg');\n  background-position: 50% 50%, 100%, 20px 20px, 50%, 0 90%;\n  -webkit-animation-name: skinRotation;\n          animation-name: skinRotation;\n  -webkit-animation-duration: 10s;\n          animation-duration: 10s;\n  -webkit-animation-iteration-count: infinite;\n          animation-iteration-count: infinite;\n  -webkit-animation-timing-function: linear;\n          animation-timing-function: linear;\n}\n.skin-inside {\n  position: relative;\n  border-radius: 100%;\n  width: 30px;\n  height: 30px;\n  left: 45%;\n  top: 45%;\n  border: 1px double rgba(3, 14, 92, 0.83);\n  background: #f0f0f0;\n}\n.skin-inside2 {\n  position: relative;\n  border-radius: 100%;\n  width: 10px;\n  height: 10px;\n  left: 28%;\n  top: 28%;\n  border: 2px double rgba(41, 74, 133, 0.83);\n  background: #FFFFFF;\n}\n@-webkit-keyframes skinRotation {\n  from {\n    -webkit-transform: rotate(0deg);\n            transform: rotate(0deg);\n  }\n  to {\n    -webkit-transform: rotate(360deg);\n            transform: rotate(360deg);\n  }\n}\n@keyframes skinRotation {\n  from {\n    -webkit-transform: rotate(0deg);\n            transform: rotate(0deg);\n  }\n  to {\n    -webkit-transform: rotate(360deg);\n            transform: rotate(360deg);\n  }\n}\n.mat-toolbar {\n  border: 6px solid rgba(28, 110, 164, 0.83);\n  border-radius: 40px 40px 40px 40px;\n}\n.mat-slider.mat-slider-horizontal .mat-slider-wrapper {\n  top: 18px;\n}\n@media screen and (max-width: 768px) {\n  .container {\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n            flex-direction: column;\n    margin: 0 auto;\n  }\n\n  body {\n    line-height: 1;\n  }\n\n  .musicList {\n    position: relative;\n    max-width: 300px;\n    border-radius: 2rem;\n    background-color: #FFFFFF;\n    padding: 1rem;\n    left: 0;\n  }\n\n  p {\n    font-size: 1rem;\n    cursor: pointer;\n  }\n  p:hover {\n    background: powderblue;\n  }\n\n  .player {\n    position: relative;\n    margin: 0px 0px 0px -28%;\n    max-width: 300px;\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n            flex-direction: column;\n  }\n\n  .text {\n    max-width: 300px;\n    background-color: #2b4e8b;\n    color: #FFFFFF;\n    text-align: center;\n    font-size: 1rem;\n    border-radius: 2rem;\n  }\n\n  .skin-no-animation {\n    position: relative;\n    border-radius: 100%;\n    background-repeat: no-repeat;\n    width: 200px;\n    height: 200px;\n    left: 15%;\n    border: 3px double rgba(28, 110, 164, 0.83);\n    background-image: url('sky.jpeg');\n    background-position: 50% 50%, 100%, 20px 20px, 50%, 0 90%;\n  }\n\n  .skin {\n    left: 15%;\n    position: relative;\n    border-radius: 100%;\n    background-repeat: no-repeat;\n    width: 200px;\n    height: 200px;\n    border: 3px double rgba(28, 110, 164, 0.83);\n    background-image: url('sky.jpeg');\n    background-position: 50% 50%, 100%, 20px 20px, 50%, 0 90%;\n    -webkit-animation-name: skinRotation;\n            animation-name: skinRotation;\n    -webkit-animation-duration: 10s;\n            animation-duration: 10s;\n    -webkit-animation-iteration-count: infinite;\n            animation-iteration-count: infinite;\n    -webkit-animation-timing-function: linear;\n            animation-timing-function: linear;\n  }\n\n  .mat-toolbar {\n    width: 300px;\n  }\n\n  .mat-button {\n    -webkit-transform: scale(0.5);\n            transform: scale(0.5);\n    min-width: 20px;\n    padding: 0;\n    margin: 0;\n  }\n\n  .mat-toolbar-single-row {\n    padding: 0;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    function () {
      ...
      _createClass(PlayerComponent, [{
        ...
        value: function pitch($event) {
          this.value = $event.value; //console.log(this.value);
  ...
  /***/
  function srcAppSelectorSelectorComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "p {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n          justify-content: center;\n}\np span {\n  margin: 0 2rem;\n  text-align: center;\n  width: 200px;\n}\np i {\n  cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppSelectorSelectorComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SelectorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-selector',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./selector.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/selector/selector.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./selector.component.scss */
      "./src/app/selector/selector.component.scss")).default]
    })], SelectorComponent);
    /***/
  },
  ...
  /***/
  function srcAppSharedDateServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(DateService, [{
        key: "changeMonth",
        value: function changeMonth(dir) {
  ...
  function srcAppSharedListMusicServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function ListMusicService() {
        ...
        this.myObservable = this.getTrack();
        this.currentID = 0;
        this.files = [{
        ...
        this.myDate = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (obs) {
          _this3.timerId = setInterval(function () {
            if (_this3.audioObj.ended === false) {
              obs.next(100 - 100 * (_this3.audioObj.duration - _this3.audioObj.currentTime) / _this3.audioObj.duration);
            } else {
              if (_this3.currentID < 2) {
                _this3.currentID = _this3.currentID + 1;
              } else {
                _this3.currentID = 0;
              }

              console.log(_this3.currentID);
              _this3.audioObj.src = _this3.files[_this3.currentID].url;

              _this3.audioObj.load();

              _this3.onplay(_this3.currentID); // setTimeout(() => { clearInterval(this.timerId); }, this.audioObj.duration);
              // obs.complete();
      ...
      _createClass(ListMusicService, [{
        ...
        value: function onplay(id) {
          ...
          this.sub = this.myDate.subscribe(function (value) {
            _this4.strTime = _this4.getformatedTime(_this4.audioObj.duration - _this4.audioObj.currentTime);
          });
  ...
  /***/
  function srcAppSharedMomentPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
