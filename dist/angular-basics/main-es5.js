...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _model_window_model_window_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./model-window/model-window.component */
    "./src/app/model-window/model-window.component.ts");
    /* harmony import */


    var _ref_directive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./ref.directive */
    ...
    function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function showWindow() {
          ...
          var modalFactory = this.resolver.resolveComponentFactory(_model_window_model_window_component__WEBPACK_IMPORTED_MODULE_2__["ModelWindowComponent"]);
          this.refDir.containerRef.clear();
          var component = this.refDir.containerRef.createComponent(modalFactory);
          component.instance.title = 'Modal window';
          component.instance.close.subscribe(function () {
            _this.refDir.containerRef.clear();
          });
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_ref_directive__WEBPACK_IMPORTED_MODULE_3__["RefDirective"], {
      static: false
    ...
    function () {
      ...
      _createClass(RegistrationComponent, [{
        ...
        value: function setCapital() {
          ...
          var city = cityMap[this.form.get('address').get('country').value];
          console.log(city);
